    ...
    return (
        <div id="graphbox" classes={graphboxStyle.root}>
            <Grid container direction='column' justify='center'>
                <Grid item xs={10} style={{ paddingLeft: '15vh' }}> <h1><span style={{ fontSize: '48px' }}>Power</span> <span style={{ color: 'orange', fontSize: '96px' }}>analysis</span></h1></Grid>


                <Grid alignItems='center' container spacing={4} direction="row" justify="space-around" className={graphboxStyle.graphGrid}>
                

                    <Grid item container xs={5} justify='space-around' spacing={2} direction='column-reverse' alignItems='center' className={graphboxStyle.tickbox}>

                        <Grid item className={graphboxStyle.textfield}>
                            The bottom right figure shows your power consumption during the year.
                            ...
                            <img className={graphboxStyle.graphImg} src={
                                (battery === 'Low') ? media.images.Glitre.Office.Low.MLPeakShaving.default : (battery === 'Mid') ?
                                    media.images.Glitre.Office.Mid.MLPeakShaving.default : (battery === 'High') ?
                                        ...
                                        alt='graphImg' />
                                    <img className={graphboxStyle.graphImg} src={media.images.Glitre.Office.Low.PowerProfileY.default} alt='graphImg' />
